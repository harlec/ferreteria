...
foreach ($ventas_list as $value) {
	...
	$datos .='<tr><td>'.$value['id_color'].'</td> 
    			<td id ="'.$value['id_color'].'" class="nom_cat">'.$value['color'].'</td> 
    			<td><button class="editar_c btn-custom" alt="editar" value="'.$value['id_color'].'"><img src="assets/img/edit.png"/></td> 
    		  </tr>';
    $i++;
}
				...
				<div class="titulo">
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-xs-3">
								<button id="addnew" style="margin-top:6px;" class="btn btn-success">+ Agregar color</button>
							</div>
						</div>
					</div>
				</div>

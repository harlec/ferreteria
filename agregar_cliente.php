...
<head>
	<meta charset="UTF-8">
	<title>Sistema - Registrar Cliente</title>
...
<body>
    ...
    <div class="main-content">
        <!-- Top Bar -->
        <div class="top-bar">
            <h1><i class="fas fa-user-plus me-2"></i>Registrar Cliente</h1>
            <div class="user-info">
        ...
        <div class="content-container">
            <!-- Sub Navigation -->
            <div class="sub-nav">
                <a href="agregar_cliente.php" class="nav-btn active">
                        ...
                        <form id="venta">
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="cliente" id="cliente" placeholder="Ingrese el nombre completo" required>
                                </div>
                            </div>
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="documento" id="documento" placeholder="DNI / RUC" required>
                                </div>
                            </div>
                            <div class="mb-4">
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.respuesta == false) {
                            ...
                            Swal.fire('Perfecto', 'Cliente registrado correctamente', 'success');
            ...
            console.log("Agregar Cliente loaded!");
        });
    </script>
</body>
</html>
